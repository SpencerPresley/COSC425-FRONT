...
export async function SideNav() {
  ...
  return (
    <div className="md:w-full border-1 border-black  dark:border-white rounded-r-sm rounded-b-xs rounded-br-xs rounded-tr-xs rounded-tl-xl rounded-bl-xl text-white dark:text-white bg-suMaroon dark:bg-suMaroon dark:bg-opacity-80 hidden lg:flex max-h-[62vh] shadow-md shadow-black">
